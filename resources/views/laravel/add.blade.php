...
<div class="modal fade" id="cliente" tabindex="-1" role="dialog" aria-labelledby="novoCliente" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="novoCliente">Cadastrar cliente</h5>
