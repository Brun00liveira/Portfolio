...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/finans/style.css') }}">
  ...
  <body>
      ...
      <nav class="navbar navbar-expand-sm navbar-light bg-warning">
        <div class="container">
          ...
          <a href="#" class="navbar-brand">
            <img src="{{ asset('image/finans/logo.png') }}" width="142">
          </a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 d-none d-md-block">
            <img src="{{ asset('image/finans/capa-mulher.png') }}">
          </div>
        </div>
      </div>
    ...
    <section class="caixa"><!--/Início seção saiba -->
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <img src="{{ asset('image/finans/saiba.png') }}" class="img-fluid">
          </div>
        </div>
      </div>
    ...
    <section class="caixa"><!--/Início seção juros -->
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="{{ asset('image/finans/juros.png') }}" class="img-fluid">
          </div>
          <div class="col-md-6 d-flex">
            <div class="align-self-center">
    ...
    <section class="caixa"><!--/Início seção recursos -->
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <img src="{{ asset('image/finans/facil.png') }}" class="img-fluid">
            <h4>Fácil de usar</h4>
            <p>
          ...
          <div class="col-md-4">
            <img src="{{ asset('image/finans/economize.png') }}" class="img-fluid">
          ...
          <div class="col-md-4">
            <img src="{{ asset('image/finans/suporte.png') }}" class="img-fluid">
            <h4>Suporte amigo</h4>
            <p>
    ...
    <footer class="mt-4 mb-4" id="footer">
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <p>
