...
<head>
	...
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="{{ asset('css/museu/normalize.css') }}">
	<link rel="stylesheet" type="text/css"href="{{ asset('css/museu/style.css') }}">
</head>
<body>
	...
	<div id="container">
		...
		<div id="principal">
			<div id="conteudo">
				<section id="capa">
					<img src="{{ asset('image/museu/museu.png') }}">
				</section>
			...
			<aside>
				<section id="depoimento">
					<img src="{{ asset('image/museu/depoimento.png') }}">
				</section>
				<section id="visita">
				...
				<section id="galeria">
					...
					<a href="">
						<img src="{{ asset('image/museu/imagem1.jpg') }}" height="93" width="93" alt="Descricao imagem">
					</a>

					<a href="">
						<img src="{{ asset('image/museu/imagem2.jpg') }}" height="93" width="93">
					</a>

					<a href="">
						<img src="{{ asset('image/museu/imagem3.jpg') }}" height="93" width="93">
					</a>

					<a href="">
						<img src="{{ asset('image/museu/imagem4.jpg') }}" height="93" width="93">
					</a>
